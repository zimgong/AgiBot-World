...
from go1.internvl.model.internlm2.modeling_internlm2 import InternLM2ForCausalLM
...
class InternVLChatModel(PreTrainedModel):
    ...
    def __init__(self, config: InternVLChatConfig, vision_model=None, language_model=None):
        ...
        if language_model is not None:
            ...
            elif config.llm_config.architectures[0] in ("InternLM2ForCausalLM", "InternLM2ForCausalLMGO1"):
    ...
    def wrap_llm_lora(self, r=128, lora_alpha=256, lora_dropout=0.05):
        ...
        elif self.llm_arch_name in ["LlamaForCausalLM"]:
            target_modules = [
                "self_attn.q_proj",
                "self_attn.k_proj",
                "self_attn.v_proj",
